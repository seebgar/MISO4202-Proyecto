...
@after {
	...
	(
		...
		{
			$current = $this_RadarChart_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_PieChart_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
