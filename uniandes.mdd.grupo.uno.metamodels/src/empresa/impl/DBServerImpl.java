...
public class DBServerImpl extends MinimalEObjectImpl.Container implements DBServer {
	 ...
	 * @ordered
	 */
	protected EList<Collection> relatedCollections;
	 ...
	 * @generated
	 */
	public EList<Collection> getRelatedCollections() {
		if (relatedCollections == null) {
			relatedCollections = new EObjectContainmentEList<Collection>(Collection.class, this, EmpresaPackage.DB_SERVER__RELATED_COLLECTIONS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EmpresaPackage.DB_SERVER__RELATED_COLLECTIONS:
				...
				getRelatedCollections().addAll((java.util.Collection<? extends Collection>)newValue);
				return;
		}
