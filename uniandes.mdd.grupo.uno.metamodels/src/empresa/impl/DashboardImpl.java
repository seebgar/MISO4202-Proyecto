 ...
 * </p>
 * <ul>
 *   <li>{@link empresa.impl.DashboardImpl#getPanels <em>Panels</em>}</li>
 *   <li>{@link empresa.impl.DashboardImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DashboardImpl extends MinimalEObjectImpl.Container implements Dashboard {
	...
	protected EClass eStaticClass() {
		return EmpresaPackage.Literals.DASHBOARD;
	}
	...
	public EList<Panel> getPanels() {
		if (panels == null) {
			panels = new EObjectContainmentEList<Panel>(Panel.class, this, EmpresaPackage.DASHBOARD__PANELS);
		}
		return panels;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmpresaPackage.DASHBOARD__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmpresaPackage.DASHBOARD__PANELS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmpresaPackage.DASHBOARD__PANELS:
				return getPanels();
			case EmpresaPackage.DASHBOARD__NAME:
				return getName();
		}
