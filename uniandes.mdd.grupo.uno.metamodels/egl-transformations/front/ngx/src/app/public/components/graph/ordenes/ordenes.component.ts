...
@Component({
  ...
  template: `<canvas id="ordenes" style="width: 100%;"></canvas>`,
...
export class OrdenesComponent implements OnInit, OnDestroy {
  ...
  /* API Routes */
  readonly API_ALL: string = "api/ordenes";
  ...
  @ViewChild("ordenes", { static: true }) chartRef: ElementRef;
...
// Generar data para el chart
  private generateData(): void {
    this.data = {
      labels: ["""org.eclipse.emf.ecore.impl.DynamicEObjectImpl@78375dfb (eClass: org.eclipse.emf.ecore.impl.EClassImpl@68bb5720 (name: Label) (instanceClassName: null) (abstract: false, interface: false))"],
      datasets: [
        {
          label: "Ordenes",
          data: [
