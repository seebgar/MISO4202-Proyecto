...
@Component({
  selector: "app-insumoschart",
  template: `<canvas id="insumoschart" style="width: 100%;"></canvas>`,
  //styleUrls: ["./insumoschart.component.scss"],
})

export class InsumosChartComponent implements OnInit, OnDestroy {
  /* Manejo de Usuario */
  public user: any = {};

  /* Titulo en HTML */
  public titulo = "InsumosChart";

  /* Indica el estado de carga */
  public cargando: boolean = false;

  /* API Routes */
  readonly API_ALL: string = "api/insumoschart";
  ...
  @ViewChild("insumoschart", { static: true }) chartRef: ElementRef;
...
// Generar data para el chart
  private generateData(): void {
    this.data = {
      labels: ["""org.eclipse.emf.ecore.impl.DynamicEObjectImpl@7425d64d (eClass: org.eclipse.emf.ecore.impl.EClassImpl@68bb5720 (name: Label) (instanceClassName: null) (abstract: false, interface: false))"],
      datasets: [
        {
          label: "Arroz",
          data: [
